...
public class Constants {
    ...
    public static final String UPDATE_USER = "update user set full_name = ?,birth = ?,start_date = ? where id_user = ?";
    ...
    public static final String FIND_BY_ID_USER_ROLE = "select *from user_role where id_user=?";
}
